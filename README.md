...
If you also want to convert recorded `.ts` files into `.mkv`, this pairs well with [ts2mkv](https://github.com/rizz360/ts2mkv), a Docker-based tool that preserves folder structure and chooses remux or encode paths with hardware fallback.
